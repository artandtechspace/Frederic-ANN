...
(library Library_1
	...
	(compDef "74HC595D_BJ_" (originalName "74HC595D_BJ_") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "QH") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "9" (pinName "QH_") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/1/74HC595D(BJ).pdf")
		(attr "Height" "1.75 mm")
	)
