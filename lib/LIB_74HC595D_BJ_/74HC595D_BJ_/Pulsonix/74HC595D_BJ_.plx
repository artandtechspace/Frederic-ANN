...
//723535/1508632/2.50/16/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "74HC595D_BJ_" (originalName "74HC595D_BJ_")
	...
	(compDef "74HC595D_BJ_" (originalName "74HC595D_BJ_") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "QH") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "9" (pinName "QH'") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "74HC595D_BJ_"))
		...
		(attr "Mouser Part Number" "757-74HC595DBJ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Toshiba/74HC595DBJ?qs=T%2FywbITssnTkqd02WdSNRg%3D%3D")
		(attr "Manufacturer_Name" "Toshiba")
		(attr "Manufacturer_Part_Number" "74HC595D(BJ)")
		(attr "Description" "Logic Gates CMOS 8-Bit Shift Register/Latch")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/74HC595D(BJ).pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "74HC595D_BJ_.stp")
