...
(library Library_1
	...
	(symbolDef "OPA196IDBVR" (originalName "OPA196IDBVR")
	...
	(compDef "OPA196IDBVR" (originalName "OPA196IDBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA196IDBVR"))
		...
		(attr "Mouser Part Number" "595-OPA196IDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA196IDBVR?qs=EU6FO9ffTwdOeFWwHLQKWg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "OPA196IDBVR")
		(attr "Description" "36V, Low Power, All-Purpose Amplifier with MUX-Friendly Input")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/opa196")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "OPA196IDBVR.stp")
