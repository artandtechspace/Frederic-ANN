...
(library Library_1
	...
	(compDef "MCP41HV51-503E_ST" (originalName "MCP41HV51-503E_ST") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "__CS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "__SHDN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "8" (pinName "NC") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/devicedoc/20005207b.pdf")
		(attr "Height" "1.2 mm")
	)
